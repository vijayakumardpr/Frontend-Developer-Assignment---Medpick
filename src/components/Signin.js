...
const Signin = () => {
  return (
    <div className="bg-[#F0F8FF] rounded-3xl p-10 flex flex-col gap-6 w-[45%]">
      ...
      <div className="px-10 flex flex-col gap-5">
        ...
        <buton className="bg-[#004F95] text-[#FFFFFF] text-center py-2 rounded-md text-xl font-semibold">Sign in</buton>
      </div>
      <div className="flex justify-center">
        <div className="text-[#7A7A7A]">New to vajra?</div>
        <div className="text-[#F78117] ml-5">Sign Up Now</div>
      </div>
    </div>
  );
};
